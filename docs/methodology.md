...
- Short positions and derivatives exposures are not modeled in Stage 1.
...
Stage 1 uses simple uniform shocks. These are diagnostics only and do not represent a full scenario engine.

Limitations:

- Shocks are simplified and uniform.
